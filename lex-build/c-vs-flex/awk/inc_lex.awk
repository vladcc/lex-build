...
function lex_read_ch() {
	# Note: the user defines lex_get_line()
	...
	if (_B_lex_peek_ch)
		...
		split(lex_get_line(), _B_lex_input_line, "")
	return _B_lex_curr_ch
}
# return the last read character
function lex_curr_ch() {return _B_lex_curr_ch}

# return the next character, but do not advance the input
function lex_peek_ch() {return _B_lex_peek_ch}

# return the position in the current line of input
function lex_get_pos() {return (_B_lex_line_pos-1)}

# return the current line number
function lex_get_line_no() {return _B_lex_line_no}
...
function lex_match_tok(str) {return (str == _B_lex_curr_tok)}

# clear the lexer write space
function lex_save_init() {_B_lex_saved = ""}

# save the last read character
function lex_save_curr_ch() {_B_lex_saved = (_B_lex_saved _B_lex_curr_ch)}

# return the saved string
function lex_get_saved() {return _B_lex_saved}

# check if a character is of a particular class
function lex_is_ch_cls(ch, cls) {return (cls == _B_lex_ch_tbl[ch])}

# see if the next character in the input is of a particular class
function lex_is_next_ch_cls(cls) {return (cls == _B_lex_ch_tbl[_B_lex_peek_ch])}

# see if what's in the lexer's write space is a keyword
function lex_is_saved_a_keyword() {return (_B_lex_saved in _B_lex_keywords)}
...
function lex_next() {
	while (1) {
		...
		if (1 == _B_lex_curr_ch_cls_cache) { # CH_CLS_SPACE()
			...
			_B_lex_curr_tok = get_word()
		} else if (3 == _B_lex_curr_ch_cls_cache) { # CH_CLS_NUMBER()
			_B_lex_curr_tok = get_number()
...
function _lex_init_keywords() {
	_B_lex_keywords["auto"] = 1
	_B_lex_keywords["break"] = 1
	_B_lex_keywords["case"] = 1
	_B_lex_keywords["char"] = 1
	_B_lex_keywords["const"] = 1
	_B_lex_keywords["continue"] = 1
	_B_lex_keywords["default"] = 1
	_B_lex_keywords["do"] = 1
	_B_lex_keywords["double"] = 1
	_B_lex_keywords["else"] = 1
	_B_lex_keywords["enum"] = 1
	_B_lex_keywords["extern"] = 1
	_B_lex_keywords["float"] = 1
	_B_lex_keywords["for"] = 1
	_B_lex_keywords["goto"] = 1
	_B_lex_keywords["if"] = 1
	_B_lex_keywords["int"] = 1
	_B_lex_keywords["long"] = 1
	_B_lex_keywords["register"] = 1
	_B_lex_keywords["return"] = 1
	_B_lex_keywords["short"] = 1
	_B_lex_keywords["signed"] = 1
	_B_lex_keywords["sizeof"] = 1
	_B_lex_keywords["static"] = 1
	_B_lex_keywords["struct"] = 1
	_B_lex_keywords["switch"] = 1
	_B_lex_keywords["typedef"] = 1
	_B_lex_keywords["union"] = 1
	_B_lex_keywords["unsigned"] = 1
	_B_lex_keywords["void"] = 1
	_B_lex_keywords["volatile"] = 1
	_B_lex_keywords["while"] = 1
}
